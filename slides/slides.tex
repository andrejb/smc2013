...
% Sumário no início de cada subseção
\AtBeginSubsection[]
{
  \begin{frame}<beamer>{Estrutura da apresentação}
    \footnotesize
...
\newcommand{\enfasev}[1]{{\color{meuvermelho}#1}}
\newcommand{\enfase}[1]{{\color{meuazul}#1}}
\newcommand{\enfaseg}[1]{{\color{dkgreen}#1}}
\newcommand{\W}[1]{\ensuremath{W_N^{#1}}}
\newcommand{\sumfty}{\ensuremath{\sum_{m=-\infty}^{\infty}}}
\newcommand{\sumnmu}{\ensuremath{\sum_{k=0}^{N-1}}}
